...
class SearchData {
	...
	SearchData.fromJson(Map<String, dynamic> json) {
		...
		cover = json['cover'] != null ? new SearchDataCover.fromJson(json['cover']) : null;
		duration = json['duration'];
		xLibrary = json['library'];
		descriptionEditor = json['descriptionEditor'];
		provider = json['provider'] != null ? new SearchDataProvider.fromJson(json['provider']) : null;
		id = json['id'];
		...
		ad = json['ad'];
		src = json['src'];
		author = json['author'] != null ? new SearchDataAuthor.fromJson(json['author']) : null;
		dataType = json['dataType'];
		searchWeight = json['searchWeight'];
		playlists = json['playlists'];
		consumption = json['consumption'] != null ? new SearchDataConsumption.fromJson(json['consumption']) : null;
		...
		if (json['playInfo'] != null) {
			playInfo = new List<SearchDataPlayinfo>();(json['playInfo'] as List).forEach((v) { playInfo.add(new SearchDataPlayinfo.fromJson(v)); });
		}
		ifLimitVideo = json['ifLimitVideo'];
		webUrl = json['webUrl'] != null ? new SearchDataWeburl.fromJson(json['webUrl']) : null;
...
class SearchDataCover {
	...
	SearchDataCover({this.feed, this.detail, this.sharing, this.blurred, this.homepage});
...
class SearchDataAuthor {
	...
	SearchDataAuthor({this.shield, this.expert, this.approvedNotReadyVideoCount, this.icon, this.link, this.description, this.videoNum, this.follow, this.recSort, this.name, this.ifPgc, this.latestReleaseTime, this.id, this.adTrack});

	SearchDataAuthor.fromJson(Map<String, dynamic> json) {
		shield = json['shield'] != null ? new SearchDataAuthorShield.fromJson(json['shield']) : null;
		expert = json['expert'];
		...
		follow = json['follow'] != null ? new SearchDataAuthorFollow.fromJson(json['follow']) : null;
...
class SearchDataConsumption {
	...
	SearchDataConsumption({this.shareCount, this.replyCount, this.realCollectionCount, this.collectionCount});
...
class SearchDataTag {
	...
	SearchDataTag({this.actionUrl, this.childTagList, this.bgPicture, this.haveReward, this.childTagIdList, this.tagRecType, this.ifNewest, this.headerImage, this.name, this.communityIndex, this.id, this.adTrack, this.desc, this.newestEndTime});
...
class SearchDataPlayinfo {
	...
	SearchDataPlayinfo({this.width, this.name, this.urlList, this.type, this.url, this.height});

	SearchDataPlayinfo.fromJson(Map<String, dynamic> json) {
		width = json['width'];
		name = json['name'];
		if (json['urlList'] != null) {
			urlList = new List<SearchDataPlayinfoUrllist>();(json['urlList'] as List).forEach((v) { urlList.add(new SearchDataPlayinfoUrllist.fromJson(v)); });
		}
		type = json['type'];
		url = json['url'];
		height = json['height'];
